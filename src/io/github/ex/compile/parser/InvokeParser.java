...
public class InvokeParser implements BaseParser{
    ...
    public ASTNode eval(Parser parser, Compiler compiler)throws CompileException {
        ...
        if(lib==null)throw new CompileException("Type name is not valid.",td, parser.filename);
        td = getTokens();
        ...
        if(function==null)throw new CompileException("Type name is not valid.",td, parser.filename);
        td = getTokens();
        ...
        try {
            ...
            throw new CompileException("')' expected.",td, parser.filename);
        }
